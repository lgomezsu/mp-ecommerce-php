<?php
// http://localhost/mp-ecommerce-php/detail4.php?img=./assets/samsung-galaxy-s9-xxl.jpg&title=Samsung%20Galaxy%20S9&price=15000&unit=1
...
*/
    $nombre = "Lalo";
    $apellido = "Landa";
    $correo = "test_user_63274575@testuser.com";
    $tel_area = "11";
    $tel_num = "22223333";
    $doc_tipo = "DNI";
    $doc_num = "12345678";
    ...
    $payer->email = $correo;
    $payer->phone = array("area_code" => $tel_area, "number" => $tel_num);
    $payer->identification = array("type" => $doc_tipo, "number" => $doc_num);
    $payer->address = array("street_name" => $dir_nom, "street_number" => $dir_num, "zip_code" => $dir_zip);
                            ...
                            <div class="width:60%">
                                        ...
                                        <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                            <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="6|Powerbeats3 Wireless Earphones - Neighborhood Collection - Brick Red|MPXP2">
                                                <div class="as-tilegallery-element as-image-selected">
                                                    <div class=""></div>
                                                    <img src="./assets/003.jpg" class="ir ir item-image as-producttile-image" alt="" width="445" height="445" style="content:-webkit-image-set(url(<?php echo $_REQUEST['img'] ?>) 2x);">
                                                </div>
                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2"><?php echo $_REQUEST['title'] ?></span>
                                                </p>
                                            </h3>
                                        </div>
                                        <h3 >
                                ...
                                <div class="form-wrap"style="float:left;min-height: 168px;">
                                    ...
                                    <form id="formcomprador" method="post" action="">
                                        ...
                                        <input type="hidden" name="title" value=<?php $_REQUEST['title'] ?>>
                                        <input type="hidden" name="img" value=<?php $_REQUEST['img'] ?>>
                                        <input type="hidden" name="price" value=<?php $_REQUEST['price'] ?>>
                                        <input type="hidden" name="unit" value=<?php $_REQUEST['unit'] ?>>
											<script
										...
										<br><br> <?php var_dump($item); ?> 
                                        <br><br> <?php var_dump($payer); ?>
                                        <br><br> <?php var_dump($preference); ?>
                                    </form>
