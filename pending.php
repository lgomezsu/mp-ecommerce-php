...
$payment_id = $_REQUEST['collection_id'];
$payment_status = $_GET['collection_status'];
...
/*
http://localhost/mp-ecommerce-php/pending.php?collection_id=12345&collection_status=approved&external_reference="lgomezsu01@gmail.com"&payment_type=credit_card&preference_id="18445959-e399ecdd-3895-4657b-8e7f-b1088b08ad4e"
*/
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div>
                          <h1>¡Ya estás más cerca de tener tu celular!</h1>
                          <br>
                          <h3>Tu compra esta en estado pendiente hasta que se acredite el dinero.<h3>
                          <br>
                          <p>Estos son los datos de tu operación:</p>
                          <p style="font-size: 0.8em">ID de Pago: <?php echo $payment_id ?> </p>
                          <p style="font-size: 0.8em">Forma de pago: <?php echo $payment_type ?> </p>
                          <p style="font-size: 0.8em">External Reference: <?php echo $external_reference ?> </p><br>
                          <a href="<?php echo "./index.php";?>" class="mercadopago-button2">
                          <button type="submit" class="mercadopago-button" formmethod="post">Volver a la Home de la Tienda</button>
                        </div>
